...
class DataLoaderDeepVoxels
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    DataLoaderDeepVoxels(const std::string config_file);
...
private:
    ...
    Eigen::Matrix3f read_intrinsics( const int side_length); // using from https://github.com/googleinterns/IBRNet/blob/master/ibrnet/data_loaders/data_utils.py
